...
class getStripeServiceService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Service\\StripeService'] = new \App\Service\StripeService($container->getEnv('STRIPE_SECRET_KEY'), ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
}
